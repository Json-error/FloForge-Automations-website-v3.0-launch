...
## Stripe Payments (2026-06-29) — Flow A claimable sandbox- 3 packages via `setup_stripe.py` lookup_keys: `starter_setup_onetime` ($299 one-time), `business_automation_onetime` ($699 one-time), `growth_partnership_monthly` ($149/mo subscription).
